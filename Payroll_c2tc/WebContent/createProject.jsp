<%@ page language="java" contentType="text/html; charset=ISO-8859-1" pageEncoding="ISO-8859-1" import="java.util.*,java.sql.*" %>
...
<h2 align="center" class="style2"> Project Allotment </h2>
